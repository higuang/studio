...
public class ContentType {
    ...
    static {
        ...
        contentTypeMap.put(".acx","application/internet-property-stream");
        ...
        contentTypeMap.put(".asr","video/x-ms-asf");
        ...
        contentTypeMap.put(".axs","application/olescript");
        ...
        contentTypeMap.put(".cat","application/vnd.ms-pkiseccat");
        ...
        contentTypeMap.put(".cmx","image/x-cmx");
        ...
        contentTypeMap.put(".cpp","text/plain");
        ...
        contentTypeMap.put(".evy","application/envoy");
        ...
        contentTypeMap.put(".flr","x-world/x-vrml");

        contentTypeMap.put(".flv","flv-application/octet-stream");
        ...
        contentTypeMap.put(".jfif","image/pipeg");
        ...
        contentTypeMap.put(".lsf","video/x-la-asf");

        contentTypeMap.put(".lsx","video/x-la-asf");
        ...
        contentTypeMap.put(".msg","application/vnd.ms-outlook");
        ...
        contentTypeMap.put(".nsnd","audiosnd");
        ...
        contentTypeMap.put(".p7c","application/x-pkcs7-mime");

        contentTypeMap.put(".p7m","application/x-pkcs7-mime");

        contentTypeMap.put(".p7r","application/x-pkcs7-certreqresp");

        contentTypeMap.put(".p7s","application/x-pkcs7-signature");
        ...
        contentTypeMap.put(".pko","application/ynd.ms-pkipko");

        contentTypeMap.put(".pm","application/x-perl");

        contentTypeMap.put(".pma","application/x-perfmon");

        contentTypeMap.put(".pmc","application/x-perfmon");

        contentTypeMap.put(".pmd","application/x-pmd");

        contentTypeMap.put(".pml","application/x-perfmon");

        contentTypeMap.put(".pmr","application/x-perfmon");

        contentTypeMap.put(".pmw","application/x-perfmon");
        ...
        contentTypeMap.put(".prop","text/plain");
        ...
        contentTypeMap.put(".rc","text/plain");
        ...
        contentTypeMap.put(".sct","text/scriptlet");

        contentTypeMap.put(".sdf","application/e-score");

        contentTypeMap.put(".sea","application/x-stuffit");

        contentTypeMap.put(".setpay","application/set-payment-initiation");

        contentTypeMap.put(".setreg","application/set-registration-initiation");
        ...
        contentTypeMap.put(".sst","application/vnd.ms-pkicertstore");

        contentTypeMap.put(".stk","application/hyperstudio");

        contentTypeMap.put(".stl","application/vnd.ms-pkistl");
        ...
        contentTypeMap.put(".xaf","x-world/x-vrml");
        ...
        contentTypeMap.put(".xof","x-world/x-vrml");
